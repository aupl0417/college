 ...
 */
//交易记录扩展分页类
class divDownloadPage extends divpage
{

    public function __construct($table,$fields = '*', $pagenow = 1, $pagesize = 20, $menustyle = 1, $where = '', $order = '')
    {
    ...
    public function getDivPage()
    {
        ...
        $sql1 = "SELECT count(*) FROM $this->table WHERE  $this->wherestr";
        $sql2 = "SELECT $this->fields FROM $this->table WHERE $this->wherestr $this->orderstr limit $_beginRow,$this->pagesize";
//        dump($sql2);
        $db = new MySql();
        //得到页数据
