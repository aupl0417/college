 ...
 */
//交易记录扩展分页类
class divpageBugList extends divpage
{
    ...
    public function getDivPage()
    {
        ...
        $sql1 = "SELECT count(*) FROM t_feedback_classify $this->wherestr";
        $sql2 = "SELECT $this->fields FROM t_feedback_classify $this->wherestr order by fc_ctime desc limit $_beginRow,$this->pagesize";
        $db = new MySql();
        //得到页数据
