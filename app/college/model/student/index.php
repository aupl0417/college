...
class index extends member {
    ...
    function run() {
        ...
        $this->setHeadTag('title', '会员中心-唐人大学'.SEO_TITLE);
        ...
        $userInfo['name'] = $userInfo['name'] ? $userInfo['name'] : $userInfo['nick'];
        $userInfo['avatar'] = $userInfo['avatar'] ? $userInfo['avatar'] : 'https://image.dttx.com/v1/tfs/T1AddTByYT1RCvBVdK.png';
        ...
        $certificate = $this->db->getField('select count(tce_id) from tang_certificate where tce_userId="' . $userId . '" and tce_userType=0');
