...
define('PROJECTNAME', '用户系统');
define('LANGUAGE', 'cn'); //语言
define('BASEURL', 'http://www.test.com'); //系统的url头
define('NAME', '测试'); //系统的名字
...
//mongodb设置
define('MONGO_DSN', 'mongodb://yikuaiyou:ZEcUWNtntowdkgIG1Rz9@218.16.98.197:27017/User');
define('MONGO_DB', 'USER');
...
define('MEMCACHE_SERVERS', 'localhost');
...
//天翼短信参数配置
//define('TYSMS_KEYID', '424859610000036680');
//define('TYSMS_SECRET', '1ace4495bb1edead8659b0fdf6004fea');
//短信网
//define('SMS_KEYID', 'dxwyoupinshiyong');
//define('SMS_SECRET', 'F8DF98F44446154231EFC6D52C7D');
//define('SMS_TYPE', 1); //短信发送平台：0-电信天翼；1-短信网
//define('TYSMS_SENDINTERVAL', 180);
//企业信使
define('SMS_USERID', '519');
define('SMS_KEYID', 'hndt');
define('SMS_SECRET', 'Hndt881S');
...
define('IGNORE_SIGN_APPS','u|www|trade|open|mob');