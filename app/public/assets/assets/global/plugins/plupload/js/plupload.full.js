		...
		function f() {
			...
			e.extend(this, w, {
				...
				getResponseHeader : function (t) {
					...
					N || ~e.inArray(t, ["set-cookie", "set-cookie2"]) ? null : k && "" !== k && (U || (U = {}, e.each(k.split(/\r\n/), function (t) {
								var n = t.split(/:\s+/);
		...
		function s() {
			...
			n.extend(this, {
				init : function (s) {
					...
					c.can("summon_file_dialog") && ("static" === i.getStyle(f, "position") && (f.style.position = "relative"), p = parseInt(i.getStyle(f, "z-index"), 10) || 1, f.style.zIndex = p, d.style.zIndex = p - 1, r.addEvent(f, "click", function (e) {
							var t = i.get(c.uid);
			...
			t.extend(this, {
				loadFromBlob : function (e) {
					...
					if (!i.can("access_binary"))
						throw new n.RuntimeError(n.RuntimeError.NOT_SUPPORTED_ERR);
					return x = e,
					e.isDetached() ? (b = e.getSource(), void h.call(this, b)) : void f.call(this, e.getSource(), function (e) {
						r && (b = l(e)),
						h.call(t, e)
					})
				},
...
(function (e, t, n) {
	...
	o.Uploader = function (e) {
		...
		function N(e, n, r) {
			...
			r ? (a.required_features = s(o.extend({}, a)), l = s(o.extend({}, a, {
							required_features : !0
