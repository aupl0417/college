...
!function (a, b) {
	var c = function (c, d) {
		...
		this.create = function (b) {
			if (!y) {
				b && (o = a.extend({}, a.fn.ace_scroll.defaults, b)),
				...
				$ && B.on("mouseenter.ace_scroll", function () {
					Z = !0,
					i(!1)
		...
		this.reset = function (a) {
			if (!w) {
				...
				if (!a || ab) {
					...
					var d = v ? A[u] : b;
					if (v && 0 == d || !v && 0 == this.element.scrollWidth)
						return void B.removeClass("scroll-active");
	...
	var c = function (b, c) {
		...
		this.pick = function (c, d) {
			if ("number" == typeof c) {
				...
				if (c = j.indexOf(e), -1 == c && d === !0 && (j.push(e), a("<option />").appendTo(f).val(e), a('<li><a class="colorpick-btn" href="#"></a></li>').appendTo(k).find("a").css("background-color", e).data("color", e), c = j.length - 1), -1 == c)
					return;
				k.find("a:eq(" + c + ")").trigger(ace.click_event)
			}
		},
...
(window.jQuery), function (a, b) {
	...
	j = function (b) {
		...
		if (f && b instanceof File) {
			...
			b instanceof Object && b.hasOwnProperty("path") && h(b.path);
		return e.promise()
	},
	k = function (b, c) {
		var d = b.width,
		...
		return this.each(function () {
			...
			for (var d in f)
				if (f.hasOwnProperty(d)) {
					...
					if ("string" == typeof g && g in e)
						g = e[g], g.name = f[d];
					else {
						if (!("object" == typeof g && g.name in e))
							continue;
					...
					case "font":
						...
						for (var i in g.values)
							g.values.hasOwnProperty(i) && (b += ' <li><a data-edit="fontName ' + g.values[i] + '" style="font-family:\'' + g.values[i] + "'\">" + g.values[i] + "</a></li> ");
						b += " </ul>";
						break;
					case "fontSize":
						b += ' <a class="btn btn-sm ' + h + ' dropdown-toggle" data-toggle="dropdown" title="' + g.title + '"><i class="' + ace.vars.icon + g.icon + '"></i>&nbsp;<i class="' + ace.vars.icon + 'fa fa-angle-down icon-on-right"></i></a> ',
						b += ' <ul class="dropdown-menu dropdown-light dropdown-caret"> ';
						for (var j in g.values)
							g.values.hasOwnProperty(j) && (b += ' <li><a data-edit="fontSize ' + j + '"><font size="' + j + '">' + g.values[j] + "</font></a></li> ");
						b += " </ul> ";
						break;
					case "createLink":
...
(window.jQuery), function (a, b) {
	...
	a.fn.ace_spinner = function (d, e) {
		...
		g = this.each(function () {
				...
				h = "object" == typeof d && d;
				g || (h = a.extend({}, a.fn.ace_spinner.defaults, d), b.data("ace_spinner", g = new c(this, h))),
...
(window.jQuery), function (a) {
	a.fn.aceWizard = a.fn.ace_wizard = function (b) {
		return this.each(function () {
			...
			e.$prevBtn.remove(),
			e.$nextBtn.remove(),
			e.$prevBtn = d.find(".btn-prev").eq(0).on(ace.click_event, function () {
					e.previous()
				}).attr("disabled", "disabled"),
			e.$nextBtn = d.find(".btn-next").eq(0).on(ace.click_event, function () {
					e.next()
				}).removeAttr("disabled"),
...
(window.jQuery), function (a, b) {
	function c(b, c) {
		...
		if (this.settings = a.extend({}, a.fn.ace_aside.defaults, c, j), !this.settings.background || c.scroll_style || j.scroll_style || (this.settings.scroll_style = "scroll-white no-track"), this.container = this.settings.container, this.container)
			try {
		...
		this.initiate = function () {
			...
			m = f.find(".modal-content"),
			this.settings.body_scroll || f.on("mousewheel.aside DOMMouseScroll.aside touchmove.aside pointermove.aside", function (b) {
		...
		this.hide = function () {
			...
			o(),
			ace.vars.transition && !i && f.one("bsTransitionEnd", function () {
				f.addClass("aside-hidden"),
				f.css("position", ""),
		...
		this.shown = function () {
			...
			e.container && ace.vars.transition && !i && f.one("bsTransitionEnd", function () {
