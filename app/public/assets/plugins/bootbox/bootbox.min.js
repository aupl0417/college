...
(this, function a(b, c) {
	...
	var n = {
		...
		footer : "<div class='modal-footer bootbox-footer' style='text-align:center!important;'></div>",
	...
	p.dialog = function (a) {
		...
		if (g(j, function (a, b) {
				...
				l[a] = b.callback
			}), i.find(".bootbox-body").html('<div class="bootbox-content"><i class="fa fa-info-circle"></i>&nbsp;&nbsp;'+a.message+'</div>'), a.animate === !0 && d.addClass("fade"), a.className && d.addClass(a.className), "large" === a.size ? f.addClass("modal-lg") : "small" === a.size && f.addClass("modal-sm"), i.before(n.header), a.closeButton) {
			var m = b(n.closeButton);
			//a.title ?  : m.css("margin-top", "-10px").prependTo(i)
			
			d.find(".modal-header").prepend(m);
			if(!d.find(".modal-header > .modal-title").html()){				
				d.find(".modal-header > .modal-title").html('温馨提示');
			};
		}
