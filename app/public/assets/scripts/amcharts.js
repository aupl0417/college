...
(function() {
    ...
    d.parseDefs = function(a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length && "object" == e) for (var h = 0; h < a[c].length; h++) e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][h], e);
...
(function() {
    ...
    d.AxisBase = d.Class({
        ...
        parseDatesDraw: function() {
            ...
            if (g == B && 1 == w && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels) n = z * this.stepWidth, this.autoWrap && !this.centerLabels && (n = -n);
            ...
            if (0 < this.gridCountR) for (A - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= A; a++) {
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(u)) for (h = 1; h < w; h += u) this.gridAlpha = this.minorGridAlpha, f = p + x * h, f = d.resetDateToMin(new Date(f), B, u, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
                this.gridAlpha = y
            }
        },
    ...
    d.ValueAxis = d.Class({
        ...
        draw: function() {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                this.exponential = !1;
                for (g = f; g < t; g += p) w = d.roundTo(this.step * g + this.min, y), -1 != String(w).indexOf("e") && (this.exponential = !0);
                ...
                if (this.autoGridCount || 0 !== this.gridCount) if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw();
                else for (t >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), h && t++, g = f; g < t; g += p) if (c = y * g + this.minCalc, c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c) if (isNaN(r) || Number(d.toFixed(c, r)) == c) {
                    ...
                    if (!isNaN(H) && 0 < w && g < t - 1) {
                        ...
                        for (B = 1; B < f; B++) z = this.getCoordinate(c + H * B), z = new this.axisItemRenderer(this, z, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(z);
                        this.gridAlpha = x
                    }
                }
                u = this.baseValue;
        ...
        zoomToValues: function(a, b, c) {
            ...
            if (this.minZoom != a || this.maxZoom != b) return this.minZoom = a, this.maxZoom = b, c || (c = {
                type: "axisZoomed"
            }, c.chart = this.chart, c.valueAxis = this, c.startValue = a, c.endValue = b, c.relativeStart = this.relativeStart, c.relativeEnd = this.relativeEnd, this.fire(c)), !0
        },
...
(function() {
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            fa && (fa.translate(ma, Y), d.setCN(p, fa, a.bcn + "tick"), d.setCN(p, fa, q, !0), g && d.setCN(p, fa, "guide"));
    ...
    d.AmGraph = d.Class({
        ...
        createRadarGraph: function() {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []);
                    ...
                    n.x = q;
                    n.y = t;
                    if (y = this.labelText) y = this.createLabel(n, y), u = 0, r && (u = r.size), this.positionLabel(n, q, t, y, u);
                    isNaN(f) && (f = q);
                    isNaN(g) && (g = t)
                }
            }
        ...
        createSerialGraph: function() {
            ...
            var m = this.useNegativeColorIfDown,
                ...
                x = [],
                w = [],
                B, z, A, C, D = this.chart.graphs.length,
            ...
            for (M = P; M <= ia; M++) {
                ...
                if (Ia) {
                    ...
                    if ("candlestick" == g || "ohlc" == g) W = Ia.close, Cb = Ia.low, qa = f.getCoordinate(Cb), Bb = Ia.high, sa = f.getCoordinate(Bb);
                    ta = Ia.open;
                    ...
                    if (!Db && W < ta || Db && W < za) v.isNegative = !0, Qa && (Ma = Qa), Za && (Va = Za), void 0 != Ja && (Ha = Ja);
                    $a = !1;
                    ...
                    case "line":
                        if (isNaN(W)) y || (this.drawLineGraph(x, w, U, V), x = [], w = [], U = [], V = []);
                            ...
                            if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb) x.push(E), w.push(F), jb = E, kb = F;
                            wa = E;
                            Da = F;
                            ja = E;
                            ka = F;
                    ...
                    case "step":
                        if (!isNaN(W)) {
                            ...
                            if (Pb || v.gap) B = z = NaN, this.drawLineGraph(x, w, U, V), x = [], w = [], U = [], V = []
                        } else if (!y) {
                    ...
                    case "candlestick":
                        if (!isNaN(ta) && !isNaN(W)) {
                            ...
                            if (t) {
                                ...
                                if (Q < q && 0 < K) {
                                    var Fb, Gb;
                                    W > ta ? (Fb = [E, ra], Gb = [O, pa]) : (Fb = [O, ra], Gb = [E, pa]);
                                    !isNaN(ra) && !isNaN(pa) && F < q && 0 < F && (Xa = d.line(h, Fb, [F, F], Aa, X, ca), cb = d.line(h, Gb, [F, F], Aa, X, ca));
                                    aa = E - O;
                                ...
                                if (S < n && 0 < K) {
                                    ...
                                    var ua = new d.Cuboid(h, K, aa, H, R, Ma, Va, ca, Aa, X, ga, u, t, da, bb, mb, Z),
                                        Hb, Ib;
                                    W > ta ? (Hb = [F, sa], Ib = [N, qa]) : (Hb = [N, sa], Ib = [F, qa]);
                                    !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Hb, Aa, X, ca), cb = d.line(h, [E, E], Ib, Aa, X, ca), d.setCN(a, Xa, this.bcn + "line-high"), v.className && d.setCN(a, Xa, v.className, !0), d.setCN(a, cb, this.bcn + "line-low"), v.className && d.setCN(a, cb, v.className, !0))
                                }
                            }
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(x, w, U, V) : this.drawLineGraph(x, w, U, V), I || this.launchAnimation();
...
(function() {
    ...
    d.ChartCursor = d.Class({
        ...
        handleMouseDown: function() {
            this.update();
            if (this.mouseIsOver()) if (this.mouseIsDown = !0, this.mouseX0 = this.mouseX, this.mouseY0 = this.mouseY, this.mouse2X0 = this.mouse2X, this.mouse2Y0 = this.mouse2Y, this.drawing) this.drawStartY = this.mouseY, this.drawStartX = this.mouseX, this.drawingNow = !0;
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (B = 0; B < x.length; B++) {
                ...
                J.translate(H, C);
                z++;
                !isNaN(l) && z >= l && (z = 0, t++, C = C + D + m, A = f, D = 0);
                y.push(J)
            }
            w = y.getBBox();
            l = w.height + 2 * m - 1;
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                (f = this.switchType) && "none" != f && 0 < m && ("x" == f ? (t = this.createX(), t.translate(m / 2, m / 2)) : t = this.createV(), t.dItem = a, !0 !== a.hidden ? "x" == f ? t.hide() : t.show() : "x" != f && t.hide(), this.switchable || t.hide(), this.addListeners(t, a), a.legendSwitch = t, l.push(t), d.setCN(b, t, "legend-switch"));
                f = this.color;
...
(function() {
    ...
    d.monthNames = "1月 2月 3月 4月 5月 6月 7月 8月 9月 10月 11月 12月".split(" ");
    d.shortMonthNames = "1月 2月 3月 4月 5月 6月 7月 8月 9月 10月 11月 12月".split(" ");
