...
class view extends worker {
    ...
    function run() {
        ...
        switch(intval($result['cr_type'])){
            case 0:
                $template = 'viewFile';
//                 $data['resourceMenu'] = '文件资源';
//                 $data['resourceButton'] = '<button type="button" class="btn btn-success"><i class="fa"></i> 添加文件</button>';
//                 $data['addButton'] = '<button type="button" class="btn btn-success"><i class="fa"></i> 添加文件</button>';
                break;
            case 1:
                $template = 'viewVideo';
                break;
