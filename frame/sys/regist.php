...
define('WORKERURL', 'workcollege' . DOMAIN);
define('OPENURL', 'open' . DOMAIN);
...
define('TFS_UPLO0AD', 'http://192.168.3.201:80/v1/tfs');//tfs上传地址
define('TFS_APIURL', 'http://192.168.3.201:80/v1/tfs');//tfs查看服务器地址
