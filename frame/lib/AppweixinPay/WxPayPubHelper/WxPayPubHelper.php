...
*/
	include_once(FRAMEROOT . '/lib/AppweixinPay/WxPayPubHelper/SDKRuntimeException.php');
	include_once(FRAMEROOT . '/lib/AppweixinPay/WxPayPubHelper/WxPay.pub.config.php');
