...
class log {
	...
	*/
	static public function writeLogMongo($type_id = 9999, $table = '', $r_id = '', $change = [], $user = '', $userType = 0, $connection = 'tanglogs') {
		//return true;
		$data = [
			...
			'log_userType'	   => isset($_SESSION['userType']) ? $_SESSION['userType'] : $userType,//操作者类型1:会员;2:雇员
			'log_time'		   => time(),//时间
